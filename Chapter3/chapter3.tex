...
Hệ thống CareerLens được thiết kế nhằm giải quyết các yêu cầu nghiệp vụ chính của thị trường tuyển dụng hiện đại:
\begin{itemize}
...
Hệ thống CareerLens được xây dựng theo mô hình kiến trúc microservices chia làm 3 tầng chính:
\begin{figure}[ht]
    \centering
    % \includegraphics[width=0.8\textwidth]{images/architecture.png}
    \caption{Kiến trúc tổng thể hệ thống CareerLens}
