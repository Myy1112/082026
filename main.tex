...
% Font Times New Roman theo quy định của trường (cỡ chữ 14pt)
\usepackage{mathptmx}
...
% Canh lề (Theo quy định: trên 3cm, dưới 3.5cm, trái 3.5cm, phải 2cm)
\usepackage[
  top=30mm,
  bottom=35mm,
  left=35mm,
...
% Phần phụ lục
% CHÚ Ý: Hai file phụ lục mẫu bên dưới đang chứa nội dung template ("Đây là phụ lục").
% Bỏ comment và điền nội dung thật (hình vẽ, bảng biểu chi tiết) trước khi nộp nếu cần phụ lục.
