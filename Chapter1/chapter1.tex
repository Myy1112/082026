...
\begin{itemize}
    \item \textbf{Chương 2 - Cơ sở lý thuyết và Công nghệ}: Trình bày các khái niệm cơ bản về giải pháp phân tích thị trường lao động (thu thập dữ liệu tự động, quy trình ETL, nguyên lý trực quan hóa), giải pháp so khớp hồ sơ (không gian vector, độ đo Cosine, khảo sát các công cụ hiện có), và trích xuất thực thể (bóc tách kỹ năng/vị trí công việc, ứng dụng LLM và Prompt).
