...
\hline
Python Programming & Đạt yêu cầu & 0.89 & Khớp với kỹ năng \texttt{Python} trong CV bằng ngữ nghĩa. \\
\hline
SQL Database & Đạt yêu cầu & 0.88 & Khớp với kỹ năng \texttt{SQL} trong CV bằng ngữ nghĩa. \\
\hline
Teamwork & Đạt yêu cầu & 0.83 & Khớp với kỹ năng \texttt{Communication} trong CV bằng ngữ nghĩa. \\
\hline
...
\begin{itemize}
    \item Số kỹ năng đạt yêu cầu (sim $\ge 0.75$): 3 kỹ năng (\texttt{Python Programming}, \texttt{SQL Database}, \texttt{Teamwork}) với các điểm tương đồng tương ứng là $0.89$, $0.88$ và $0.83$.
    \item Số kỹ năng thiếu hụt (sim $< 0.40$): 3 kỹ năng (\texttt{Pandas}, \texttt{Power BI}, \texttt{Git}), đóng góp không đáng kể vào điểm tổng.
    \item Điểm số so khớp cuối cùng (theo công thức tương đồng có trọng số, giả định trọng số đồng đều):
    \begin{equation}
    \text{Match Score} = \frac{0.89 + 0.88 + 0.83 + 0 + 0 + 0}{6} \times 100\% \approx 43.33\%
    \end{equation}
\end{itemize}
